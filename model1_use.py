...
def create1_2(num_epochs, inputPeom):
    from trainData1 import x_train, y_train, x_test, y_test, w_to_id, id_to_w
    ...
    checkpoint_save_path = "./checkpoint2-1/run_embedding_lprel.ckpt"
